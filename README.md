...
## a fun note
i learnt more about vim basics, and how plugins like black help with lazyvim to code in python and get it running, since i didnt want to use vscode or any heavy ide, which helped me learn:
